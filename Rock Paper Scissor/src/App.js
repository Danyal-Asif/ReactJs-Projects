...
const comboMoves=userChoice+computerChoice
  if(userPoints<=4 && computerPoints<=4){
    if(['rockscissors','paperrock','scissorspaper'].includes(comboMoves)){
    ...
    if(['paperscissors','scissorsrock','rockpaper'].includes(comboMoves)){
    ...
    if(['rockrock','scissorsscissors','paperpaper'].includes(comboMoves)){
